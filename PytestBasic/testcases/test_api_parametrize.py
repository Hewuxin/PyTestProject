...
from PytestBasic.common.send_requests import SendRequest
from PytestBasic.common.yaml_utils import write_yaml, read_all_yaml, read_yaml
...
class TestApi:
    ...
    @pytest.mark.parametrize("login_yaml", read_all_yaml(
        "/Users/heyuyang/Study/PyProject/TestProject/PytestBasic/testcases/test_login.yaml"))
